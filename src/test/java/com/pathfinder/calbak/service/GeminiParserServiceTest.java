...
class GeminiParserServiceTest {
    ...
    void parseSchedule_TextOnly_Success() {
        ...
        String mockResponseBody = "{"
            ...
            + "\\\"repeatPattern\\\": \\\"NONE\\\", \\\"repeatEndDate\\\": null} ]\""
            + "}]"
            + "}"
            + "}]"
            + "}";
    ...
    void parseScheduleText_MarkdownCodeFence() {
        ...
        String mockResponseBody = "{"
            ...
            + "\"content\": {"
            + "\"parts\": [{"
            + "\"text\": \"\\u0060\\u0060\\u0060json\\n[ { \\\"title\\\": \\\"마크다운 테스트\\\", \\\"startDate\\\": \\\"2026-06-10\\\", \\\"endDate\\\": \\\"2026-06-10\\\", \\\"isAllDay\\\": true, \\\"repeatPattern\\\": \\\"NONE\\\", \\\"repeatEndDate\\\": null } ]\\n\\u0060\\u0060\\u0060\""
            + "}]"
            + "}"
            + "}]"
            + "}";
    ...
    void parseScheduleText_NullEndDateFallback() {
        ...
        String mockResponseBody = "{"
            ...
            + "\"content\": {"
            + "\"parts\": [{"
            + "\"text\": \"[ { \\\"title\\\": \\\"폴백 테스트\\\", \\\"startDate\\\": \\\"2026-06-10\\\", \\\"endDate\\\": null, \\\"isAllDay\\\": true, \\\"repeatPattern\\\": \\\"WEEKLY\\\", \\\"repeatEndDate\\\": null } ]\""
            + "}]"
            + "}"
            + "}]"
            + "}";
